...
serviceNameLo="jjbot"                                  # service name with the first letter in lowercase
serviceName="jjbot"                                    # service name
serviceUser="jjbot"                                      # OS user name for the service
serviceGroup="jjbot"                                    # OS group name for the service
...
javaArgs="-jar $applDir/jjBot-1.0.0.0-SNAPSHOT-my-jar-with-dependencies.jar"                     # arguments for Java launcher
javaCommandLine="$javaExe $javaArgs"                       # command line to start the Java service application
javaCommandLineKeyword="jjBot-1.0.0.0-SNAPSHOT-my-jar-with-dependencies.jar"                     # a keyword that occurs on the commandline, used to detect an already running service process and to distinguish it from others
